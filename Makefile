...
lenet_files = $(main_fun)/lenetMain.cpp $(extra_fun)/inputFromText.cpp $(extra_fun)/Trans.cpp $(io_fun)/display.cpp $(convo_fun)/3Dconv.cpp $(convo_fun)/convolution.cpp $(poolpad_fun)/*.cpp lenet.cpp $(ac_fun)/Relu.cpp $(ac_fun)/Softmax.cpp
