...
mainIn = convolution.cpp display.cpp inputFromText.cpp main.cpp matMul.cpp mkl.cpp openblas.cpp outfile.cpp padding.cpp pooling.cpp Pthread.cpp Relu.cpp Sigmoid.cpp Softmax.cpp Tanh.cpp Trans.cpp normalMatMul.cpp mklblascomm.cpp

mkl_files = display.cpp random.cpp Pthread.cpp mkl.cpp outfile.cpp mklMain.cpp mklblascomm.cpp

pthread_files = display.cpp random.cpp Pthread.cpp outfile.cpp pthreadsMain.cpp

openblas_files = display.cpp random.cpp openblas.cpp outfile.cpp openblasMain.cpp mklblascomm.cpp
